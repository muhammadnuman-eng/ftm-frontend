...
export async function generateMetadata({
    ...
    return generateGlobalMetadata({
        locale,
        pageType: "instantPage",
        pagePath: "/ftm-instant-funding",
    });
}
...
const CARD_CONFIG = [
    {
        ...
        link: "/variations?category=instant&program=instant-standard",
    },
    {
        key: "pro",
        icon: CrownIcon,
        ...
        link: "/variations?category=instant&program=instant-pro",
    },
    {
        key: "plus",
        icon: PlusIcon,
        gradientPosition: "top-left" as GradientPosition,
        iconClassname:
            "bg-[radial-gradient(66.67%_103.95%_at_50%_-42.76%,var(--color-indigo-300)_0%,var(--color-indigo-600)_100%)]",
        link: "/variations?category=instant&program=instant-plus",
    },
] as const;
...
const BENEFIT_CONFIG = [
    ...
    },
    {
        ...
        gradientPosition: "top-right" as GradientPosition,
        iconClassname:
            "bg-[radial-gradient(66.67%_103.95%_at_50%_-42.76%,var(--color-purple-300)_0%,var(--color-purple-600)_100%)]",
    },
    {
        key: "drawdownReset",
        icon: TrendingUpIcon,
        ...
        iconClassname:
            "bg-[radial-gradient(66.67%_103.95%_at_50%_-42.76%,var(--color-pink-300)_0%,var(--color-pink-600)_100%)]",
    },
    {
        key: "drawdownType",
        icon: TrophyIcon,
...
const InstantPage = async ({
    ...
    const { locale: localeParam } = await params;
    const locale = normalizeLocale(localeParam);
    const t = await getTranslations({ locale, namespace: "instantPage" });
    ...
    return (
        <div className="mx-auto max-w-7xl space-y-12 px-4 py-12 sm:py-24 md:px-6 lg:px-8">
            ...
            <ComparisonTableWrapper locale={locale} type="Instant" />
