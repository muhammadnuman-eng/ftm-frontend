...
const CARD_CONFIG = [
    {
        ...
        link: "/variations?category=2-step&program=standard",
    },
    {
        key: "speed",
        icon: CrownIcon,
        ...
        link: "/variations?category=2-step&program=speed",
    },
    {
        key: "plus",
        icon: PlusIcon,
        ...
        link: "/variations?category=2-step&program=plus",
    },
] as const;
...
const TwoStepPage = async ({
    ...
    const { locale: localeParam } = await params;
    const locale = normalizeLocale(localeParam);
    const t = await getTranslations({ locale, namespace: "twoStepPage" });
    ...
    return (
        <div className="mx-auto max-w-7xl space-y-12 px-4 py-12 sm:py-24 md:px-6 lg:px-8">
            ...
            <ComparisonTableWrapper locale={locale} type="2-Step" />
